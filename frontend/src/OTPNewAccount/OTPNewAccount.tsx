            ...
            <div className=" flex flex-col items-left sm:items-center w-fit">
              <div className="w-fit flex flex-col">
                ...
                <input
                  ...
                  className="w-[190px] no-spinner font-sans text-base p-2 text-center sm:rounded-3xl border border-solid sm:bg-transparent border-gray-300 focus:outline-custom-blue"
                />
              </div>
            </div>
