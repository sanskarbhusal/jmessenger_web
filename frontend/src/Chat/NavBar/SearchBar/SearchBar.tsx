  ...
  render() {
    return (
      <label
        ...
        className={
          "mr-[18px] border-[2px] min-h-[40px] border-solid rounded-full bg-gray-200/50" +
          " " +
          "border-" +
      ...
      >
        <div
          className={
            "min-h-[40px] grid grid-cols-search_bar grid-row-1 bg-white border border-solid rounded-full" +
            " " +
            "border-" +
