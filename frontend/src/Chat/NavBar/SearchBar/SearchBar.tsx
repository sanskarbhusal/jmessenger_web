  ...
  render() {
    return (
      <label
        ...
        className={
          "mr-[18px] border-[2px] min-h-[40px] border-solid rounded-full bg-white" +
          " " +
          "border-" +
      ...
      >
        <div
          className={
            "min-h-[40px] grid grid-cols-search_bar grid-row-1 bg-transparent border border-solid rounded-full" +
            " " +
            "border-" +
