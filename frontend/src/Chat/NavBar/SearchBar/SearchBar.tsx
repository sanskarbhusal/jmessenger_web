  ...
  render() {
    return (
      <div
        ...
        className={
          "transition mr-[18px] min-h-[41px] rounded-full border-[1px] bg-gray-300/85 sm:bg-transparent shadow-none shadow-custom-blue/15" +
          " " +
          "border-" +
      ...
      >
        <div
          className={
            "min-h-[40px] grid grid-cols-search_bar grid-row-1 border-[1px] bg-white sm:bg-transparent rounded-full shadow-inner" +
            " " +
            "border-" +
