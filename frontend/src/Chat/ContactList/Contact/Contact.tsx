  ...
  render() {
    return (
      <div
        ...
        className="w-full h-fit hover:drop-shadow-md bg-transparent hover:bg-custom-blue/5 hover:shadow-md active:bg-custom-blue/10 font-sans border-[0px] border-gray-300/85 flex flex-row items-center"
      >
