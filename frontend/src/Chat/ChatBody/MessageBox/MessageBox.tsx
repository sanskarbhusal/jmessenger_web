  ...
  render() {
    return (
      <div className={"relative pt-[10px] pb-[10px] w-full h-full flex flex-row justify-center items-start sm:items-center sm:bg-transparent" + " " + this.props.className}>
        ...
        <div className="hidden transition sm:block sm:peer-focus:hidden  absolute z-0 bottom-[19px] h-[71%] w-[97%] blur-sm rounded-3xl bg-custom-blue/30 sm:peer-focus:shadow-inner sm:peer-focus:drop-shadow-lg  "></div>
      </div>
    );
  }
}
