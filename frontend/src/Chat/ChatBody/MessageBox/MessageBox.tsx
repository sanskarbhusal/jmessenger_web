...
export default class MessageBox extends React.Component<Props, State> {
  ...
  state = {};
  render() {
    return <div className={"w-full h-full flex flex-row justify-center items-start sm:items-center sm:focus:drop-shadow-md bg-white" + " " + this.props.className}>
      <div className="w-[90%] sm:w-[80%] h-[50px] sm:h-[52px] bg-white">
