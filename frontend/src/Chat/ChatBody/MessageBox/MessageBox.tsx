    ...
    return (
      <div className={"relative mt-1 pt-[10px] pb-[10px] w-full h-full flex flex-row justify-center items-start sm:items-center sm:bg-transparent" + " " + this.props.className}>
        <textarea
          ...
          className="peer field-sizing-content overflow-hidden pt-[12px] w-[92%] sm:min-w-[92%] sm:max-w-[92%] sm:min-h-[54px] sm:max-h-[200px] overflow-y-scroll scrollbar-thin font-normal text-lg text-black  font-sans rounded-3xl rounded-r-none border-[1px] border-custom-blue/45 border-r-0 bg-white sm:bg-gray-100 pl-10 pr-10 placeholder-gray-500/80 outline-none ring-0 focus:ring-0 focus:outline-none resize-none selection:bg-custom-blue/90 selection:text-white">
        </textarea>
        <div className="peer-focus: flex flex-row justify-center items-center h-[54px] w-[52px] border-[1px] border-l-0 border-custom-blue/45 bg-gray-100 rounded-r-3xl">
