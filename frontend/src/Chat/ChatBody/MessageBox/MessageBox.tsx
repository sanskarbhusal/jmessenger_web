    ...
    return <div className={"w-full h-full flex flex-row justify-center items-start sm:items-center sm:bg-custom-blue/10" + " " + this.props.className}>
      <div className="h-full w-full flex flex-row justify-center items-center">
        <textarea
          ...
          spellCheck="false"
          placeholder="Message"
          className="relative overflow-auto sm:bottom-[6px] w-[90%] sm:w-[96%] min-h-[50px] sm:h-[52px] text-lg text-black font-medium font-sans rounded-3xl border-[1px] border-gray-300 focus:border-gray-400 bg-white drop-shadow-sm shadow-inner pl-10 pr-10 placeholder-gray-500/80 outline-none">
        </textarea>
      </div>
    </div>;
  }
