      ...
      <div className={"relative w-ful h-[100%] flex flex-col justify-center items-center sm:bg-transparent" + " " + this.props.className}>
        <div className="relative z-10 w-[96%] m-[6px] bottom-[10px] flex flex-row justify-center items-start bg-transparent">
          <textarea
            ...
            className="peer field-sizing-content sm:flex overflow-hidden pt-[9px] w-full sm:min-h-[100%] sm:max-h-[200px] overflow-y-scroll scrollbar-thin font-normal text-lg text-black  font-sans rounded-3xl rounded-r-none border-[1px] border-custom-blue/45 border-r-0 bg-white sm:bg-gray-100 pl-10 pr-10 placeholder-gray-500/80 outline-none ring-0 focus:ring-0 focus:outline-none resize-none selection:bg-custom-blue/90 selection:text-white">
          </textarea>
          <div className="relative sm:flex z-10 peer-focus: flex flex-ro justify-center items-end p-[3px] min-h-[100%] w-[52px] border-[1px] border-l-0 border-custom-blue/45 bg-gray-100 rounded-r-3xl">
