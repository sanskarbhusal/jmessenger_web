    ...
    return <div className={"w-full h-full flex flex-row justify-center items-start sm:items-center sm:transparent" + " " + this.props.className}>
      <div className="relative h-full w-full flex flex-row justify-center items-center">
        <textarea
          ...
          spellCheck="false"
          placeholder="Message"
          className="peer field-sizing-content overflow-hidden relative z-10 sm:bottom-[6px] w-[90%] sm:w-[96%] minn-h-[50px] text-lg text-black font-medium font-sans rounded-3xl border-[1px] border-gray-300 bg-white sm:bg-gray-100 sm:drop-shadow-none shadow-inner pl-10 pr-10 placeholder-gray-500/80 outline-none ring-0 focus:ring-0 focus:outline-none resize-none">
        </textarea>
        <div className="hidden transition sm:block sm:peer-focus:bg-custom-blue/30 absolute z-0 bottom-[19px] h-[71%] w-[97%] blur-sm rounded-3xl bg-custom-blue/20  "></div>
      </div>
    </div>;
  }
}
