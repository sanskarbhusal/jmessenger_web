  ...
  render() {
    return (
      <div className="relative w-full h-full flex flex-row justify-center items-center sm:bg-custom-blue/5">
        <div className="hidden sm:block blur-sm rounded-3xl absolute z-0 w-[97%] h-[100%] bg-custom-blue/10"></div>
        <div className="hidden sm:block relative z-10 bg-white w-[96%] h-[98%] rounded-3xl">
