...
export default class ChatBubble extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="sm:w-[45%] group sm:self-end sm:bg-white sm:rounded-xl">
        <div className="w-full h-full flex flex-col bg-custom-blue/10 sm:border border-custom-blue/30 rounded-xl sm:rounded-br-none selection:bg-custom-blue/90 selection:text-white">
          <div className="pl-3 pt-2 w-full h-full flex  whitespace-break-spaces font-normal text-base rounded-xl text-pretty">
