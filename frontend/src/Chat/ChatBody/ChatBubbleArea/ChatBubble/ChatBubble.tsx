...
export default class ChatBubble extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div className="hidden sm:w-[45%] group sm:self-end sm:mt-10 sm:mb-10 sm:mr-10 sm:bg-white sm:rounded-xl">
