  ...
  render() {
    return (
      <div className="h-full w-full flex items-center sm:justify-center sm:bg-custom-blue/10">
        <div className="w-fit h-fit sm:bg-white">
            ...
            <div className=" flex flex-col items-left sm:items-center w-fit">
              <div className="w-fit flex flex-col">
                ...
                <input
                  ...
                  className="w-[202px] font-sans text-base p-2 sm:rounded-lg border border-solid sm:bg-transparent border-gray-300 focus:outline-custom-blue"
                />
              </div>
            </div>
